...
<template>
  <div class="scheduleContainer">
    ...
    <div class="scheduleContent">
      ...
      <h3 :class="{ inactive: !shouldShowBlock('11:50') }">
        Morning
      ...
      <ScheduleBlock
        ...
        :show="shouldShowBlock('9:00')"
        v-if="isOpen[0]"
      />
      <ScheduleBlock
        time="9:00 AM to 9:15 AM"
        title="Welcome to CPOSC!"
        :show="shouldShowBlock('9:15')"
        v-if="isOpen[0]"
      />
      <ScheduleBlock
      ...
      <ScheduleBlock
        ...
        title="Session 3"
        :sessions="session3"
        :show="shouldShowBlock('11:50')"
        v-if="isOpen[0]"
      />
      <h3 :class="{ inactive: !shouldShowBlock('13:00') }">
        Lunch
      ...
      <ScheduleBlock
        ...
        v-if="isOpen[1]"
      />
      <h3 :class="{ inactive: !shouldShowBlock('15:50') }">
        Afternoon
      ...
      <ScheduleBlock
        ...
        :show="shouldShowBlock('17:30')"
        v-if="isOpen[2]"
      />
      <h3 :class="{ inactive: !shouldShowBlock('24:00') }">
        Evening
  ...
  data() {
    return {
      ...
      session4: [
        ...
        { speaker: [""], title: "Birds of a Feather", desc: "Flock, together! Join us in the library to talk to local technologists about local tech." }
      ],
      session5: [
