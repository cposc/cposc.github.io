  ...
  data() {
    return {
      ...
      session2: [
        ...
        { speaker: ["murph"], title: "Hacker Public Radio - Why You Should Listen, and Contribute", desc: "Hacker Public Radio is a community podcast that run 5 days a week.  It is dedicated to sharing knowledge and has been running in various forms for nearly 20 years.  Anyone that has anything that is of interest to hackers is welcome to submit a show." }
      ],
      session3: [
