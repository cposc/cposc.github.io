<template>
  ...
  <div class="right">
      ...
      <img
        ...
        :alt="name"
        src="@/2026/assets/speakers/AlexMayer.png"
      />
      <img
        v-if="name === 'Brad Lhotsky'"
        :alt="name"
        src="@/2026/assets/speakers/BradLhotsky.jpeg"
      />
      <img
        v-if="name === 'Don Demcsak'"
        :alt="name"
        src="@/2026/assets/speakers/DonDemcsak.jpg"
      />
      <img
        v-if="name === 'Dustin Betz'"
        :alt="name"
        src="@/2026/assets/speakers/DustinBetz.png"
      />
      <img
        v-if="name === 'Edward Schwartz'"
        :alt="name"
        src="@/2026/assets/speakers/EdSchwartz.webp"
      />
      <img
        v-if="name === 'Eric Lease Morgan'"
        :alt="name"
        src="@/2026/assets/speakers/EricMorgan.jpg"
      />
      <img
        v-if="name === 'Jeff Barrett'"
        :alt="name"
        src="@/2026/assets/speakers/JeffBarrett.jpg"
      />
      <img
        v-if="name === 'Jonathan Bowe'"
        :alt="name"
        src="@/2026/assets/speakers/JonathanBowe.jpg"
      />
      <img
        v-if="name === 'Jonathan Bowman'"
        :alt="name"
        src="@/2026/assets/speakers/JonathanBowman.jpg"
      />
      <img
        v-if="name === 'Logan Farr'"
        :alt="name"
        src="@/2026/assets/speakers/LoganFarr.jpg"
      />
      <img
        v-if="name === 'R. Geoffrey Avery'"
        :alt="name"
        src="@/2026/assets/speakers/RGeoffreyAvery.jpg"
      />
      <img
        v-if="name === 'Rich Everts'"
        :alt="name"
        src="@/2026/assets/speakers/RichEverts.jpg"
      />
      <img
        v-if="name === 'Stephanie Schwartz'"
        :alt="name"
        src="@/2026/assets/speakers/StephanieSchwartz.jpg"
      />
      <img
        v-if="name === 'One Small Step for an Axolotl (FTC Robotics Team 25650)'"
        :alt="name"
        src="@/2026/assets/speakers/TeamAxolotl.jpg"
      />
      <img
        v-if="name === 'Tom Courtney'"
        :alt="name"
        src="@/2026/assets/speakers/TomCourtney.jpg"
      />
      <img
        v-if="name === 'Walt Mankowski'"
        :alt="name"
        src="@/2026/assets/speakers/WaltMankowski.jpeg"
      />
