<script setup>
import HeaderBanner from "./HeaderBanner/HeaderBanner.vue";
...
<template>
  <HeaderBanner />
  <TopNav />
  <!-- <h3>Where bits meet brilliance and bytes build community</h3> -->
...
.cta-button {
  ...
  background: linear-gradient(45deg, #11998e, #7dd3fc);
  color: white;
  padding: 15px 30px;
